...
public class SectionService {
    ...
    public SectionService(SectionRepo sectionRepo, ScheduledTaskRepo<SectionImportTaskDef> taskRepo, CourseService courseService, CanvasService canvasService, ApplicationEventPublisher eventPublisher) {
    ...
    public void syncSectionTask(SectionImportTaskDef task){
        List<edu.ksu.canvas.model.Section> canvasSections = canvasService.getCourseSections(task.getCanvasId())
