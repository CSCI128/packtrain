...
export interface OperationMethods {
   ...
   */
  'delete_course'(
    parameters?: Parameters<Paths.DeleteCourse.QueryParameters & Paths.DeleteCourse.PathParameters> | null,
    data?: any,
    config?: AxiosRequestConfig  
   ...
   */
  'deny_extension'(
    parameters?: Parameters<Paths.DenyExtension.PathParameters> | null,
    data?: any,
    config?: AxiosRequestConfig  
